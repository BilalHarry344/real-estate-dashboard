    ...
    <div className="min-h-screen bg-gray-50">
      <header className="bg-white shadow-md fixed w-full top-0 z-50">
        <nav className="max-w-7xl mx-auto">
          <div className="flex justify-between h-20 px-4 lg:px-4 md:px-4 sm:px-0">
      ...
      <main className="max-w-7xl mx-auto py-6 mt-20 px-4 lg:px-4 md:px-4 sm:px-0">
        {children}
      </main>
      <footer className="bg-gray-900 text-white mt-16">
        <div className="max-w-7xl mx-auto py-12 px-4 lg:px-4 md:px-4 sm:px-0">
